//Escreva um programa em Java para gerar uma matriz W (N x M). Ordene os elementos da matriz de forma decrescente e imprimir a matriz original e a matriz ordenada.
...
public class Exercicio26 {
	...
	public static void main (String[] args) {
		...
		System.out.println("Imprimindo a matriz ordenada de forma decrescente:");
        for (int i = 0; i < matriz.length; i++) {
			for (int j = 0; j < matriz[i].length; j++) {
				System.out.print(matriz[i][j] + "\t");
			}
